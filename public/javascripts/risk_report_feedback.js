        ...
        _.forEach(data.rows, function(v){
          ...
          //  else {
            html += '<a href="/edit_risk/'+ v.id+'" data-toggle="tooltip" data-placement="top" title="แก้ไข" class="btn btn-warning"> <i class="glyphicon glyphicon-pencil"></i></a>  '+
                    '<a class="btn btn-info" type="button", href="/risk_repeat_user_feedback/'+ v.id +'/'+ v.depcode +'" data-toggle="tooltip" data-placement="top" title="ทบทวน"> <i class="glyphicon glyphicon-book"></i></a>';
            ...
            if(!data.date_repeat || !data.result_repeat ) {
                ...
                $.ajax({
                    ...
                    .success(function(data) {
                        ...
                        window.location.href="/user_risk_report_feedback";
                    })
